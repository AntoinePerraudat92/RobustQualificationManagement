...
class CCGSolverTest(TestCase):
    ...
    def test_simple_problem_with_two_products_and_two_factories(self):
        ...
        self.assertAlmostEqual(6.2, solver.get_qualification_costs())
        self.assertAlmostEqual(0.0, solver.get_lost_sales())

    def test_simple_problem_with_one_product_and_lost_sales(self):
        nmb_products = 1
        nmb_factories = 2
        ...
        self.assertAlmostEqual(100.0, solver.get_lost_sales())
